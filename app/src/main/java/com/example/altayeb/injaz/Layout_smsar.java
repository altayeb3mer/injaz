...
public class Layout_smsar extends AppCompatActivity {
    private static String[] depts_array;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_smsar);
    }
    ...
    public void onclick(View view) {
        ...
        for (int i = 0; i < depts_array.length; i++) {
            ...
            if (view.getTag().toString().equals(id)) {
                ...
                Toast.makeText(Layout_smsar.this, depts_array[i], Toast.LENGTH_SHORT).show();
            }}
    }
}
