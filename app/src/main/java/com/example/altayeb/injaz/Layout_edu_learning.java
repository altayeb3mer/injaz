...
public class Layout_edu_learning extends AppCompatActivity {
    private static String[] depts_array;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.layout_edu_learning);
    }
    ...
    public void onclick(View view) {
        ...
        for (int i = 0; i < depts_array.length; i++) {
            ...
            if (view.getTag().toString().equals(id)) {
                ...
                Toast.makeText(Layout_edu_learning.this, depts_array[i], Toast.LENGTH_SHORT).show();
            }}
    }
}
